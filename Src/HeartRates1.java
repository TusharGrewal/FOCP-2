...

{
...

    {
        ...
        HeartRates r = new HeartRates(firstname, lastname, day, month, year);
        ...
        System.out.println("Age in years: "+ r.getAge());
        System.out.println("Maximum Heartrate: "+ r.MaxHeartRates());
        r.targetHeartRate();
